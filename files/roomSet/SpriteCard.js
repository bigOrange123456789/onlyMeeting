function SpriteCard() {
    ...
    this.initChar0=function (message) {//创建字体精灵
        this.text=message;
    ...
    this.setGradient=function (context) {
        // 创建渐变
        var gradient=context.createLinearGradient(0,0,this.text.length*this.fontsize,0);
    ...
    //this.init('Welcome!');
    //这里是第二十届中国虚拟现实大会网络虚拟会场，
    //首先请允许我隆重地为大家介绍出席本次大会的两位重量级嘉宾。
