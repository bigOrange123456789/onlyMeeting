...
function LightManager(){
    ...
    this.createSpotLight=function(pos){
        ...
        obj.getComponent(Web3DEngine.Light).type="Spot";//聚光灯
        obj.getComponent(Web3DEngine.Light).castShadow=true;
        obj.getComponent(Web3DEngine.Light).intensity=20;
        obj.getComponent(Web3DEngine.Light).range=15;
        obj.getComponent(Web3DEngine.Light).spotAngle=20*Math.PI/180;//40;
        return obj;
    }
    this.init=function(){
