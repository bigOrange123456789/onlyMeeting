function ParamMeasure(obj,type){
    ...
    this.ControlTJSObj=function (obj) {
        ...
        document.onkeydown = function (e) {
            ...
            else if (e.key == "v") console.log(Math.round(obj.position.x*100)/100+','
                +Math.round(obj.position.y*100)/100+','
                +Math.round(obj.position.z*100)/100,obj.scale);
            if (e.key == '=') {
                if (This.beforeKey == '1') obj.scale.x += 0.1;
                else if (This.beforeKey == '2') obj.scale.y += 0.1;
                else if (This.beforeKey == '3') obj.scale.z += 0.1;
            } else if (e.key == '-') {
                if (This.beforeKey == '1') obj.scale.x -= 0.1;
                else if (This.beforeKey == '2') obj.scale.y -= 0.1;
                else if (This.beforeKey == '3') obj.scale.z -= 0.1;
